...
<head>
    ...
    <title>Chatty - Public Chat</title>
...
<Header Class="Site-Header">          
		  ...
		  <Nav Class="Site-Navigation">
			  <Ul Class="Nav">
				  ...
				  <!-- <Li><button type="button" id="logout-btn" onclick="window.location.href='https://www.youtube.com/'" ><i class="bi bi-youtube"></i>YouTube</button></A></Li> -->
...
<footer class="footer">
    <div class="copy">&copy; CHATTY DEVELOPERS</div>
